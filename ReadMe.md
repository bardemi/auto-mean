...
## Was fehlt und was gemacht werden muss
![Aufgabe1](./hilfreich/Aufgabe1.png "")
![Auto-Modell](./hilfreich/auto-modell.png "")
![npm-befehle](./hilfreich/npm-befehle.png "")

via npm Fremdsoftware installieren. Modell mit mongoose und MongoDB implementieren. 
Restclient implementieren. Test mit jest.
